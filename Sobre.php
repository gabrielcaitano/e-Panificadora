    ...
    <div class="w3-content" style="max-width:1000px">
        <div class="w3-row w3-padding-32">
            <div class="w3-col m6 w3-padding-large">
                <img src="./imagens/Logo_V2.png" class="w3-border w3-round w3-image  w3-animate-top" alt="Logo"
                    width="600" height="750">
            </div>

            <div class="w3-col m6 w3-padding-large w3-animate-right">
                <h1 class="w3-center">Nossa História</h1><br>
                <h5 class="w3-center">Desde 2000</h5>
                <p class="w3-large">
                    Tudo começou com um mero projeto, um sonho de criança, que achávamos que não daria muito certo, mas
                    com muito empenho e dedicação construímos nosso Império, na verdade construímos nossa panificadora.
                    A panificadora Rainha tem muito mais do que vocês podem imaginar para oferecer, diversas variedades
                    de sabores e uma ótima qualidade.
                    Não deixem de provar os nossos mais variados pratos.
                    Desde já obrigado.
